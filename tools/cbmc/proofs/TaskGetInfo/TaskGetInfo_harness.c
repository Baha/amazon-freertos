...
// TODO: Discuss whether it is ok to patch xSchedulerRunning
...
void harness()
{
	...
	// TaskHandle_t xTask = malloc(sizeof(TCB_t));
	TaskStatus_t *pxTaskStatus = malloc(sizeof(TaskStatus_t));
	BaseType_t xGetFreeStackSpace;
	eTaskState eState;

	// BaseType_t pucStackByte = & (xTask.pxStack);
	// for (int i = 0; i < 5; i++)
	// 	*pucStackByte = 
